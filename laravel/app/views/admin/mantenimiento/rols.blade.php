...
@section('includes')
    ...
    @include( 'admin.mantenimiento.js.roles_ajax' )
    @include( 'admin.mantenimiento.js.roles' )
@stop
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table id="t_roles" class="table table-bordered table-hover">
                                <thead>
                                <tr><th colspan="2" style="text-align:center;background-color:#A7C0DC;"><h2>Roles</h2></th></tr>
                                <tr></tr>
                                </thead>
                                <tbody>
                                </tbody>
...
@section('formulario')
     @include( 'admin.mantenimiento.form.rol' )
@stop
